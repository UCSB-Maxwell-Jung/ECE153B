...
void SPI1_Init(void)
{
	/*___________________PART_A_DECLARATIONS_________________________*/
	// GPIO_InitTypeDef GPIO_InitStructure;					//1
	// SPI_InitTypeDef  SPI_InitStructure;					//2
	// DMA_InitTypeDef DMA_InitStructure;					//3
	...
	/*___________________PART_B_SPI_____________________*/
	...
	//SPI_Cmd(SPI1, ENABLE);  //enables the SPI peripheral
	// SPI1_ReadWriteByte(0xff);

	/*___________________PART_C_DMA_____________________*/
	...
	/*___________________PART_D_NVIC_____________________*/
	...
	/*___________________PART_E_DMA_____________________*/
