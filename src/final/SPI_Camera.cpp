...
SPI_Camera::SPI_Camera()
    : SPI(SPI2) {}

void SPI_Camera::configure_GPIO() {
	// [DONE]
	...
	GPIOB->MODER &= ~(GPIO_MODER_MODER13_0 | // PB13
					  GPIO_MODER_MODER14_0 | // PB14
					  GPIO_MODER_MODER15_0); // PB15
	...
	af_num = 5;
	GPIOB->AFR[1] |= (af_num << (13*4)); // PB13
	GPIOB->AFR[1] |= (af_num << (14*4)); // PB14
	GPIOB->AFR[1] |= (af_num << (15*4)); // PB15
