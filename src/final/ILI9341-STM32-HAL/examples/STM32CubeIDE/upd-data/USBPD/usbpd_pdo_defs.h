...
#define USBPD_CORE_PDO_SNK_FIXED_MIN_VOLTAGE_MV    5000
#define USBPD_CORE_PDO_SNK_FIXED_MAX_VOLTAGE_MV   20000

#define USBPD_CORE_PDO_SNK_FIXED_MAX_CURRENT_MA    3000
...
uint32_t PORT0_PDO_ListSNK[USBPD_MAX_NB_PDO] =
{
  /* PDO 1 */
  (
    ( (PWR_A_10MA(USBPD_CORE_PDO_SNK_FIXED_MAX_CURRENT_MA / 1000.0)) << USBPD_PDO_SNK_FIXED_OP_CURRENT_Pos ) |
  ...
  (
    ( (PWR_A_10MA(USBPD_CORE_PDO_SNK_FIXED_MAX_CURRENT_MA / 1000.0)) << USBPD_PDO_SNK_FIXED_OP_CURRENT_Pos ) |
    ( (PWR_V_50MV(USBPD_CORE_PDO_SNK_FIXED_MAX_VOLTAGE_MV / 1000.0)) << USBPD_PDO_SNK_FIXED_VOLTAGE_Pos )    |
    USBPD_PDO_SNK_FIXED_DRD_SUPPORTED                                                                        |
    USBPD_PDO_SNK_FIXED_USBCOMM_SUPPORTED                                                                    |
    USBPD_PDO_SNK_FIXED_EXT_POWER_NOT_AVAILABLE                                                              |
    USBPD_PDO_SNK_FIXED_HIGHERCAPAB_SUPPORTED                                                                |
